 ...
 *This class represents a MotorBike vehicle.
 *It extends the base Vehicle class and overrides the getVehicleType()
 *method to return "motorbike".
...
public class MotorBike extends Vehicle{
  ...
  public MotorBike(String regnId, String model, String colour,String dateOfEntry, String timeOfEntry, int x, int y) {
